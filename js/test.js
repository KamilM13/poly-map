...
//////////////////////////////////////
//NOTE Planet class for creating orbs
class Planet {
...
//////////////////////////////////////
//NOTE config for systems and connections
...
const config = {
  planets: [
    ...
    { name: 'Rind', size: 2, x: -20, y: 100, z: -20, texture: 'image/image/neutral.png', layer: 5 },
    { name: 'Fester', size: 2, x: -20, y: 100, z: 0, texture: 'image/image/neutral.png', layer: 5 },
    { name: 'Hoxxes', size: 2, x: -20, y: 100, z: 20, texture: 'image/image/neutral.png', layer: 5 },
    { name: 'Destitution', size: 2, x: 0, y: 100, z: 0, texture: 'image/image/neutral.png', layer: 5 },
...
const createLabel = (text, parent) => {
  ...
  loader.load('font.json', function (font) {
    ...
    parent.add(mesh);
    textLabels.push(mesh);  // Store reference to text labels for billboarding
  });
};
...
function animate() {
  textLabels.forEach((label) => {
    label.lookAt(camera.position);  // Make the label face the camera
  });
